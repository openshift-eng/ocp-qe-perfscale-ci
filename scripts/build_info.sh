...
if [[ -z $SHARED_DIR && -z $ARTIFACT_DIR ]]; then
    ...
    curl -sL "https://mirror2.openshift.com/pub/openshift-v4/x86_64/clients/ocp/latest/opm-linux-rhel9.tar.gz" -o opm-linux-rhel9.tar.gz
    tar xf opm-linux-rhel9.tar.gz
    OPM_BIN="./opm-rhel9"
fi
